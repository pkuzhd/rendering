...
public:
	...
	public:
        ...
        virtual my_index_t element_num() const = 0;
        ...
        virtual const my_value_t &get_value_list(const my_index_t &line_index , const my_index_t &property_index) const = 0;
        ...
        virtual const my_byte_t &get_byte_list(const my_index_t &line_index , const my_index_t &property_index) const = 0;
        virtual const std::string &get_comment_type() const = 0;
        virtual const std::string &get_comment_address() const = 0 ;
	} ;
...
public:
    ...
    my_index_t element_num() const{
        return mPointer ->element_num();
    }
    ...
    const my_byte_t &get_byte_list(const my_index_t &line_index , const my_index_t &property_index) const{
        return mPointer->get_byte_list(line_index,property_index);
    }
    ...
    const my_value_t &get_value_list(const my_index_t &line_index , const my_index_t &property_index) const{
        return mPointer->get_value_list(line_index,property_index);
    }
    ...
    const std::string &get_comment_type() const {
        return  mPointer->get_comment_type();
    }
    const std::string &get_comment_address() const {
        return mPointer->get_comment_address();
    }
private:
